...
Usage 💡
Explore: Move around the map to see pinned activities.
Search: Use the search bar to find specific locations or activities. If you search for a city (e.g., "Delhi"), the AI will automatically find its coordinates and move the map.
Login: Click the "Login" button securely sign in with your Google account.
Join & Chat: Click on an activity to see its details. "Join" the activity to let others know you're interested, and open the chat to connect with fellow attendees.
